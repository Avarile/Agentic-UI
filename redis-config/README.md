...
This directory contains comprehensive Redis configuration files and scripts for Cybernetics development and testing, supporting both cluster and single-node setups with optional TLS encryption.
...
REDIS_CA=/path/to/cybernetics-agentics/redis-config/certs/ca-cert.pem
```
...
### 2. Configure Cybernetics for TLS
...
ls -la /path/to/cybernetics-agentics/redis-config/certs/ca-cert.pem

# Test Cybernetics Redis configuration
cd /path/to/cybernetics-agentics
npm run backend
